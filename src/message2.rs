...
mod test {
    ...
    #[test]
    fn create_message() {
        let message = Message2::create(MessageType::Ping, 1);
    ...
    #[test]
    fn count_alive() {
        let mut message = Message2::create(MessageType::Ping, 1);
    ...
    #[test]
    fn from_bytes() {
        let message = Message2::create(MessageType::PingAck, 1);
        let buffer = message.into_inner();
        let message = Message2::from_bytes(buffer.as_ref(), buffer.len());
